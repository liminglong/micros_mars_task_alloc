...
class Robot_patrol(multiprocessing.Process):
    ...
    def run(self):
        rospy.init_node('robot_patrol_area2')
        print 'Patroller 2 starts!'
        client = actionlib.SimpleActionClient('robot_2/move_base', multi_robot_patrol.msg.MoveBaseAction)
        client.wait_for_server()

        #Several goals to be sent to the action server.
        goal1 = multi_robot_patrol.msg.MoveBaseGoal()
        goal1.target_pose.header.frame_id = 'map'
        goal1.target_pose.pose.position.x = 7.36
        ...
        goal2.target_pose.pose.position.x = 9.20
        ...
        goal3.target_pose.pose.position.x = 9.20
        ...
        goal4.target_pose.pose.position.x = 7.36
