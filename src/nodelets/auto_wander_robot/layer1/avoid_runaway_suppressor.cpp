...
typedef micros_mars_task_alloc::Suppressor<micros_mars_task_alloc::Heading> AvoidRunawaySuppressor;

}//namespace micros_mars_task_alloc
PLUGINLIB_EXPORT_CLASS(micros_mars_task_alloc::AvoidRunawaySuppressor, nodelet::Nodelet)
